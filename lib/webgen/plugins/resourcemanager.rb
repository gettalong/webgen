...
module Webgen
  ...
  class ResourceManager < Plugin
    ...
    def define_webgen_resources
      define_file_resource( 'webgen-logo', File.join( Webgen::Configuration.data_dir, 'resources', 'images', 'webgen_logo.png' ),
                            '/images/webgen-logo.png' ).predefined = "The logo of webgen as seen on the homepage."
      define_file_resource( 'webgen-generated', File.join( Webgen::Configuration.data_dir, 'resources', 'images', 'generated_by_webgen.png' ),
                            '/images/webgen-generated-by.png' ).predefined = "A 88x31 image for use on web sites that were generated by webgen."
      define_file_resource( 'w3c-valid-css', File.join( Webgen::Configuration.data_dir, 'resources', 'images', 'valid-css.gif' ),
