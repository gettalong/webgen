...
class TestTagMenu < MiniTest::Unit::TestCase
  ...
  def test_static_call
    ...
    assert_tag_result("<ul class=\"other\"><li class=\"webgen-menu-level1 webgen-menu-submenu webgen-menu-submenu-inhierarchy\"><a href=\"../\"></a><ul><li class=\"webgen-menu-level2 webgen-menu-submenu webgen-menu-submenu-inhierarchy\"><a href=\"./\">dir</a><ul><li class=\"webgen-menu-level3 webgen-menu-item-selected\"><a href=\"subfile.html\">subfile</a></li></ul></li></ul></li></ul>",
                      context, {:ancestors => true}, 'nested', 'other')

    assert_tag_result("<ul class=\"menu\"><li class=\"webgen-menu-level1 webgen-menu-submenu webgen-menu-submenu-inhierarchy\"><a href=\"../\"></a></li></ul><ul><li class=\"webgen-menu-level2 webgen-menu-submenu webgen-menu-submenu-inhierarchy\"><a href=\"./\">dir</a></li></ul><ul><li class=\"webgen-menu-level3 webgen-menu-item-selected\"><a href=\"subfile.html\">subfile</a></li></ul>",
                      context, {:ancestors => true}, 'flat', 'menu')
  end

  def assert_tag_result(result, context, options, style, css_class)
